          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<int>(
                value: _panelIndex,
                items: const [
                  DropdownMenuItem(value: 1, child: Text('חלונית 1')),
                  DropdownMenuItem(value: 2, child: Text('חלונית 2')),
                  DropdownMenuItem(value: 3, child: Text('חלונית 3')),
                  DropdownMenuItem(value: 4, child: Text('חלונית 4')),
                ],
                onChanged: (v) => setState(() {
                  if (v != null) _panelIndex = v;
                }),
